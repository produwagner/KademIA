export function applyAccentColorToDOM(hexColor) {
  ...
  // Hover color: slightly darker/richer shade (85% brightness)
  ...
  targets.forEach((target) => {
    ...
    // Text contrast on accent buttons
    const luminance = (0.299 * r + 0.587 * g + 0.114 * b) / 255;
    target.style.setProperty("--color-on-accent", luminance > 0.55 ? "#071200" : "#ffffff");
  });
}
